...
public class Test_Tuan8 {
    ...
    private static void khoiTao () {
        ...
        // Lưu ý: Tên "Nguyen Thi Mo" đã được đổi thành "Nguyen Thi Mo"
        SachGiaoTrinh sgt01 = new SachGiaoTrinh ("sgt01", "TOAN ROI RAC", 
        "Nguyen Thi Mo", 2020, 100, "TOAN", "Dai hoc", 50000, "sach giao trinh");
        SachTieuThuyet stt01 = new SachTieuThuyet ("stt01", "PASSION", 
        "YUUJI", 2024, 1000, "sach tieu thuyet", 50000, "ROMANCE", true);
    ...
    private static void capNhatViTri() {
        ...
        // Phuong thuc nay da bao gom ca viec in ra thong bao
