...
public class QuanLySach implements IQuanLySach{
    ...
    public void themSach() {
        ...
        System.out.print("Chon the loai (1. Giao trinh  2. Tieu thuyet): ");
        ...
        if (loai == 1) {
            ...
            sach = new SachGiaoTrinh(ma, tieuDe, tacGia, nam, sl, giaCoBan, vitri, monHoc, capDo);
        } else if (loai == 2) {
            System.out.print("Nhap the loai: ");
            String theLoai = sc.nextLine();
            System.out.print("Sach co thuoc series khong? (true/false): ");
            boolean laSeries = Boolean.parseBoolean(sc.nextLine());
            sach = new SachTieuThuyet(ma, tieuDe, tacGia, nam, sl, giaCoBan, vitri, theLoai, laSeries);
        }
